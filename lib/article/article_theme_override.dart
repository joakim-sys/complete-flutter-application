...
class ArticleThemeOverride extends StatelessWidget {
  const ArticleThemeOverride(
      {super.key, required this.isVideoArticle, required this.child});
  ...
  Widget build(BuildContext context) {
    ...
    return ContentThemeOverrideBuilder(builder: (context) {
...
class ArticleThemeColors extends ThemeExtension<ArticleThemeColors>
  ...
  const ArticleThemeColors(
      {required this.captionNormal, required this.captionLight});
  ...
  @override
  ThemeExtension<ArticleThemeColors> lerp(
      covariant ThemeExtension<ArticleThemeColors>? other, double t) {
