  ...
  group('TrcApiClient', () {
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = TrcApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => TrcApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
    ...
    group('getArticle', () {
      ...
      test(
          'throws TrcApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<TrcApiMalformedResponse>()),
        );
      });

      test(
          'throws TrcApiRequestFailure '
