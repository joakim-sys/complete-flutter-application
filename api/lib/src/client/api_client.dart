...
class TrcApiMalformedResponse implements Exception {
  /// {@macro api_malformed_response}
  const TrcApiMalformedResponse({required this.error});
...
/// {@endtemplate}
class TrcApiRequestFailure implements Exception {
  /// {@macro api_request_failure}
  const TrcApiRequestFailure({
...
/// {@template api_client}
/// A Dart API client for the TRC API.
/// {@endtemplate}
class TrcApiClient {
  /// Create an instance of [TrcApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro api_client}
  TrcApiClient({
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        TrcApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
